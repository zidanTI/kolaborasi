                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> : 
                                    @if ($daftar->status_daftar === 'baru')
                                        <span style="color: white; background-color: green; padding: 3px 8px; border-radius: 5px; display: inline-block;">
                                            {{ ucfirst($daftar->status_daftar) }}
                                        </span>
                                    @else
                                        {{ ucfirst($daftar->status_daftar) }}
                                    @endif
